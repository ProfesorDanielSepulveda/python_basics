...
print("Casi todo lo que se sitúa entre comillas es texto")
>Casi todo lo que se sitúa entre comillas es texto
...
print('esto es texto o str')
>esto es texto o str

type(print('esto es texto o str'))
><class 'str'>
